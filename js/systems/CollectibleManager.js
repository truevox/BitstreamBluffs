// js/systems/CollectibleManager.js
...
export default class CollectibleManager {
    constructor(scene, terrainManager) {
        ...
        // Extra life parameters from physics config
        this.extraLifeConfig = PhysicsConfig.extraLives;
    }
    ...
    manageExtraLives(currentTime) {
        ...
        const minSpawnDelay = this.extraLifeConfig.minSpawnDelay;
